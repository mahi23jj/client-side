...
// ---------- Content with dynamic bg ----------
interface DropdownMenuContentProps
  extends React.ComponentProps<typeof DropdownMenuPrimitive.Content> {
  bgColor?: string; // optional gradient background
}

function DropdownMenuContent({
  className,
  sideOffset = 4,
  bgColor = "from-blue-50 via-white to-blue-100", // default gradient
  ...props
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          `bg-gradient-to-br ${bgColor} text-popover-foreground
    ...
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        `relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none
         ...
         data-[variant=destructive]:focus:bg-red-100 data-[variant=destructive]:focus:text-red-600
    ...
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        `flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none
         focus:bg-blue-100 focus:text-blue-900 data-[state=open]:bg-blue-100 data-[state=open]:text-blue-900
         data-[inset]:pl-8`,
        className
      )}
      {...props}
...
function DropdownMenuSubContent({ className, ...props }: React.ComponentProps<typeof DropdownMenuPrimitive.SubContent>) {
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        `bg-gradient-to-br from-blue-50 via-white to-blue-100 text-popover-foreground
         data-[state=open]:animate-in data-[state=closed]:animate-out
         data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0
         data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95
         data-[side=bottom]:slide-in-from-top-2
